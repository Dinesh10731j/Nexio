        ...
        <div className="mx-auto max-w-md h-[200px] w-[300px] md:h-[700px] md:[700px] mt-16 p-5 rounded-lg  bg-white">
          <div className="profile-header flex items-center justify-between mb-4">
            ...
            <button 
              ...
              className={`py-2 px-4 rounded-lg text-white ${isFollowing ? 'bg-gray-500' : 'bg-blue-500'}`}
            >
          ...
          <div className="flex flex-col items-center mb-4">
            <div className="relative">
              <Image src={dummyImage} alt="Profile" className="w-32 h-32 rounded-full object-cover" />
          ...
          <div className="profile-body mt-4">
            ...
            <div className="status-selector mt-4">
              <label className="block text-gray-600 font-semibold mb-2">Mood:</label>
              <select 
                value={status} 
